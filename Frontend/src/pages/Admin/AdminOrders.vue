<template> 
    <h1 class="text-2xl mb-6 font-bold">Orders</h1>
          ...
          >
            ...
            <td class="px-6 py-4">
                <select
                    ...
                    :class="['rounded shadow shadow-md shadow-gray-400 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white', getStatusClass(order.action)]"
                    >
    ...
    methods: {
        ...
        updateOrderStatus(order) {
          ...
          console.log("Action:", order?.action);
              ...
              axios.put(`http://localhost:3000/orders/${order.id}`, {
                action: order.action
              })
              .then(() => {
