<template>
  ...
  <!-- main pagul propriuzis -->
      ...
      <div class="section1">
          ...
          <div class="colImages">
            <div class="image">
              <img src="https://placehold.co/500x500" alt="placeholder image" class="w-full h-full object-cover">
            </div>
          </div>
      ...
      <div class="section2 mt-3 mx-3">
        ...
        <div class="w-full max-w-sm  rounded-lg  dark:border-gray-700">
            <a href="#">
                <img class="p-8 rounded-t-lg bg-gray-50" src="https://flowbite.com/docs/images/products/apple-watch.png" alt="product image" />
            </a>
            <div class="px-5 pb-5">
                <a href="#">
                    <h5 class="text-xl font-semibold tracking-tight text-black dark:text-black">Apple Watch Series 7 GPS, Aluminium Case, Starlight Sport</h5>
                </a>
                <br>
                <div class="flex items-center justify-between">
                    <span class="text-3xl font-bold text-black dark:text-black">$599</span>
